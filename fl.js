...

{
  ...
  pesan : '[>] Masukkan Nama Pengguna:' ,

  validasi : function ( value ) {

    if ( ! value )  mengembalikan  'Can Empty' ;
...

{
  ...
  message : '[>] Insert Sleep (MiliSeconds) (Gunakan [|] jika lebih dari 1):' ,
...
console.log(chalk`
  ...
  ——————————————————  [THANKS TO RIZIQ]  ————————————————————
  [✓] CODER BY RZQRSDF (https://ig.me/rzqrsdff)
  [✓] FIXING & TESTING BY RZQRSDF
